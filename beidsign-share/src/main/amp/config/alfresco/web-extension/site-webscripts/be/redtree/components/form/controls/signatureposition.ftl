...
of a defined "signatureField" in the PDF document.
 -->
<script type="text/javascript" src="${url.context}/res/beidsign/components/signature-position/signature-position.js"></script>
<link rel="stylesheet" type="text/css" href="${url.context}/res/beidsign/components/signature-position/signature-position.css" />
...
var BeidSign = new BeidSign.SignaturePosition("${fieldHtmlId}").setOptions(
      {
